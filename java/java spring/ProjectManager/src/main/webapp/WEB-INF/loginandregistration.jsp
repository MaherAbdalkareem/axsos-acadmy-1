...
<div class="row">
  ...
  <div class="row">
    <form:input path="firstName"  class="form-control" aria-describedby="nameHelpInline"/>
  </div>
  <div class="row">
  ...
  <div class="row">
    <form:input path="lastName"  class="form-control" aria-describedby="nameHelpInline"/>
  </div>
  <div class="row">
